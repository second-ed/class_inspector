...
class TestClass:
    ...
    def _do_something(self) -> bool:
        return self.z_

    def _do_something_internally(self) -> float:
        return self._x - self.y

    def _do_something_derived_(self) -> bool:
...
def get_mock_service_parametrized_tests():
    return (
        ...
        "    [\n"
        "        pytest.param(param, expected_result, expected_context),\n"
        "        pytest.param(param, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
        ...
        "    [\n"
        "        pytest.param(data, expected_result, expected_context),\n"
        "        pytest.param(data, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
...
def get_mock_utils_c_parametrized_tests():
    return (
        ...
        "    [\n"
        "        pytest.param(filepath, expected_result, expected_context),\n"
        "        pytest.param(filepath, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
        ...
        "    [\n"
        "        pytest.param(value, expected_result, expected_context),\n"
        "        pytest.param(value, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
        ...
        "    [\n"
        "        pytest.param(data_dict, expected_result, expected_context),\n"
        "        pytest.param(data_dict, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
        ...
        "    [\n"
        "        pytest.param(data, filepath, expected_result, expected_context),\n"
        "        pytest.param(data, filepath, None, pytest.raises(TypeError)),\n"
        "        pytest.param(data, filepath, None, pytest.raises(TypeError)),\n"
        "    ]\n"
        ")\n"
